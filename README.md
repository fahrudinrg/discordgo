...
[![Go Reference](https://pkg.go.dev/badge/github.com/fahrudinrg/discordgo.svg)](https://pkg.go.dev/github.com/fahrudinrg/discordgo) [![Go Report Card](https://goreportcard.com/badge/github.com/fahrudinrg/discordgo)](https://goreportcard.com/report/github.com/fahrudinrg/discordgo) [![CI](https://github.com/fahrudinrg/discordgo/actions/workflows/ci.yml/badge.svg)](https://github.com/fahrudinrg/discordgo/actions/workflows/ci.yml) [![Discord Gophers](https://img.shields.io/badge/Discord%20Gophers-%23discordgo-blue.svg)](https://discord.gg/golang) [![Discord API](https://img.shields.io/badge/Discord%20API-%23go_discordgo-blue.svg)](https://discord.com/invite/discord-api)
...
```sh
go get github.com/fahrudinrg/discordgo
```
...
```go
import "github.com/fahrudinrg/discordgo"
```
...
- [![Go Reference](https://pkg.go.dev/badge/github.com/fahrudinrg/discordgo.svg)](https://pkg.go.dev/github.com/fahrudinrg/discordgo) 
...
- [DiscordGo Examples](https://github.com/fahrudinrg/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/fahrudinrg/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/fahrudinrg/discordgo/wiki/Troubleshooting) 
